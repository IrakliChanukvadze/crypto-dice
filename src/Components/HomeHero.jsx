...
const HomeHero = () => {
  return (
    <div className={`${responsiveCont} pt-24`}>
      <div className="w-[94%] m-auto pt-10 ">
        <div className="w-full border-b-[1px] border-b-[#F2F2F2] flex text-white flex-col xl:flex-row pb-6 gap-4  md:gap-6 xl:gap-0">
          <h2 className="flex-1  text-[#1D84E2] text-[48px] leading-[48px] md:text-[100px] md:leading-[80px] xl:leading-[120px] xl:text-[120px] font-bold">
